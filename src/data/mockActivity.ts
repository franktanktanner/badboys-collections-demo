...
export const mockActivity: Activity[] = [
  ...
  { id: 'a21', timestamp: ago(118), type: 'sms',          title: 'SMS sequence fired',   description: 'Day-14 urgency tier for Anaheim delinquents',                              outcome: '18 portal clicks',        office: 'Anaheim' },
  ...
  { id: 'a25', timestamp: ago(152), type: 'email',        title: 'Email sequence sent',  description: 'Balance statements auto-mailed to 73 San Bernardino indemnitors',          outcome: '39% open rate',           office: 'San Bernardino' },
  ...
  { id: 'a27', timestamp: ago(175), type: 'ai_call',      title: 'AI call completed',    description: 'Contacted Theresa Coleman — dispute opened, escalated to supervisor',      outcome: 'Dispute flag',            office: 'Long Beach' },
  { id: 'a28', timestamp: ago(187), type: 'legal',        title: 'Demand letter sent',   description: 'Certified letter delivered for BB-2024-1049 (day 194)',                     office: 'Riverside' },
  { id: 'a29', timestamp: ago(201), type: 'payment',      title: 'Payment received',     description: 'Check from Camila Ramirez cleared on BB-2024-1065',                       amount: 1450,  outcome: 'Cleared',                 office: 'Modesto' },
  { id: 'a30', timestamp: ago(215), type: 'sms',          title: 'SMS sequence fired',   description: 'Stockton office — 32 payment reminders at optimal send window',             outcome: '12 replies',              office: 'Stockton' },
  ...
  { id: 'a33', timestamp: ago(257), type: 'payment',      title: 'Payment received',     description: 'Card payment from Carmen Vasquez on plan day-1',                           amount: 540,   outcome: 'Cleared',                 office: 'Long Beach' },
  { id: 'a34', timestamp: ago(271), type: 'ai_call',      title: 'AI call completed',    description: 'No contact on BB-2024-1067 — voicemail left, retry at 6 PM',               outcome: 'Voicemail',               office: 'Riverside' },
  { id: 'a35', timestamp: ago(288), type: 'escalation',   title: 'Account escalated',    description: 'BB-2024-1054 escalated at day 187 — collateral review triggered',          office: 'Anaheim' },
  { id: 'a36', timestamp: ago(305), type: 'payment_plan', title: 'Payment plan created', description: 'AI built 15-mo restructure for Fatima Abdullah (BB-2024-1050)',            outcome: '$380/mo',                 office: 'Anaheim' },
  ...
  { id: 'a38', timestamp: ago(340), type: 'legal',        title: 'Demand letter queued', description: 'BB-2024-1068 legal queue (day 268) — attorney review pending',             office: 'San Bernardino' },
  ...
  { id: 'a40', timestamp: ago(377), type: 'sms',          title: 'SMS sequence fired',   description: 'Modesto office — 28 day-1 reminders',                                      outcome: '6 portal visits',         office: 'Modesto' },
  { id: 'a41', timestamp: ago(395), type: 'payment',      title: 'Payment received',     description: 'Check from Andre Foster on BB-2024-1069',                                  amount: 1120,  outcome: 'Cleared',                 office: 'Stockton' },
];
